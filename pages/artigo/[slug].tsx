        ...
        <div className={styles.artigo__content}>
          ...
          <div className={styles.artigo__footer}>
            ...
            <div className={styles.artigo__share}>
              ...
              {/* Facebook */}
              <Link href={`https://www.facebook.com/sharer/sharer.php?u=https://blog.codeskills.com.br/artigo/${postData.slug}/`}>
                <a target="_blank">
              ...
              {/* Twitter */}
              <Link href={`https://twitter.com/intent/tweet?text=${postData.title}&url=https://blog.codeskills.com.br/artigo/${postData.slug}/`}>
                <a target="_blank">
